...
CREATE TABLE "new_Event" (
    ...
    CONSTRAINT "Event_parentCompanyId_fkey" FOREIGN KEY ("parentCompanyId") REFERENCES "Company" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
...
INSERT INTO "new_Event" ("acquirerCompanyId", "acquirerNameRaw", "amount", "createdAt", "description", "fromCountry", "id", "importance", "intoSolutionId", "month", "newCity", "newCountry", "newName", "newOwnerCompanyId", "note", "outcome", "round", "subjectCompanyId", "subjectSolutionId", "type", "updatedAt", "withCompanyId", "year") SELECT "acquirerCompanyId", "acquirerNameRaw", "amount", "createdAt", "description", "fromCountry", "id", "importance", "intoSolutionId", "month", "newCity", "newCountry", "newName", "newOwnerCompanyId", "note", "outcome", "round", "subjectCompanyId", "subjectSolutionId", "type", "updatedAt", "withCompanyId", "year" FROM "Event";
DROP TABLE "Event";

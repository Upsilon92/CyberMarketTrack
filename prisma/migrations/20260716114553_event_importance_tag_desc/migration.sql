...
ALTER TABLE "Tag" ADD COLUMN "descriptionFr" TEXT;
...
INSERT INTO "new_Event" ("acquirerCompanyId", "acquirerNameRaw", "amount", "createdAt", "description", "id", "intoSolutionId", "month", "newName", "newOwnerCompanyId", "note", "outcome", "round", "subjectCompanyId", "subjectSolutionId", "type", "updatedAt", "withCompanyId", "year") SELECT "acquirerCompanyId", "acquirerNameRaw", "amount", "createdAt", "description", "id", "intoSolutionId", "month", "newName", "newOwnerCompanyId", "note", "outcome", "round", "subjectCompanyId", "subjectSolutionId", "type", "updatedAt", "withCompanyId", "year" FROM "Event";
DROP TABLE "Event";
